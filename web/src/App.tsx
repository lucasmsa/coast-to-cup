  ...
  return (
    <header className="flex items-center justify-between gap-3 px-4 md:px-6 h-14 md:h-16 border-b border-line/70 shrink-0">
      <div className="flex items-baseline gap-4 min-w-0">
        <span className="font-display text-lg md:text-3xl tracking-[0.05em] uppercase whitespace-nowrap">
      ...
      <div className="flex items-center gap-2 md:gap-4 shrink-0">
        ...
        <a
          ...
          className="hidden sm:block text-mut hover:text-fg transition-colors"
        >
