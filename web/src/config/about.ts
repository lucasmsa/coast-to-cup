...
export interface AboutSection {
  title: string
  body: string[]
  /** Optional inline citation: the exact phrase (within body) to turn into a link. */
  cite?: { phrase: string; url: string }
}
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'The phase selector keeps the comparison fair. "All" ranks every team over all its games; "Group stage", "R32", "R16" and beyond compare only the teams that reached that round, each over the same number of games.',
        ],
        cite: { phrase: 'roughly 4–8 PM body time', url: PEAK_STUDY_URL },
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'O seletor de fase mantém a comparação justa. "Todos" ranqueia cada seleção por todos os seus jogos; "Fase de grupos", "16 avos", "Oitavas" e adiante comparam só as seleções que chegaram àquela fase, cada uma pelo mesmo número de jogos.',
        ],
        cite: { phrase: 'entre cerca de 16h e 20h no horário do corpo', url: PEAK_STUDY_URL },
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'El selector de fase mantiene la comparación justa. "Todos" clasifica a cada selección por todos sus partidos; "Fase de grupos", "16vos", "Octavos" y más allá comparan solo a las selecciones que llegaron a esa ronda, cada una por el mismo número de partidos.',
        ],
        cite: { phrase: 'entre las 16 y las 20 h en la hora del cuerpo', url: PEAK_STUDY_URL },
      },
      {
